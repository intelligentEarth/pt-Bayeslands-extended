...
def main():
    ...
    fname = ""
    run_nb = 0
    while os.path.exists(problemfolder +'xresults_%s' % (run_nb)):
        run_nb += 1
    if not os.path.exists(problemfolder +'xresults_%s' % (run_nb)):
        os.makedirs(problemfolder +'xresults_%s' % (run_nb))
        fname = (problemfolder +'xresults_%s' % (run_nb))
    ...
    run_nb_str = 'xresults_' + str(run_nb)
    ...
    resultingfile_db = open(problemfolder+'/result_file_temporalrain.txt','a+')  
