...
class ParallelTempering:
    ...
    def view_crosssection_uncertainity(self,  list_xslice, list_yslice):
        ...
        #topo_file=pd.read_csv('Examples/etopo/data/nodes.csv',header=None,delimiter='\s+')
...
def main():
    ...
    if problem == 1:
        ...
        gaussian_blur_std_min=0.5
        gaussian_blur_std_max=10
        
        vertical_offset_min=-5 #mm/yr
        vertical_offset_max=5 #mm/yr
        
        minlimits_vec=[0.5,-5,1]
        maxlimits_vec=[10,5,1]   
        ...
        maxlimits_vec = [0.5,1, 1, 1, 1, 1] 
        minlimits_vec = [10 ,1, 1, 1, 1, 1]   
        ...
        if (true_parameter_vec.shape[0] != vec_parameters.size ) :
            print( 'true_parameter_vec needs same shape as vec_parameters')
            print( true_parameter_vec.shape[0], vec_parameters.size )
    ...
    #Remove temp files
    #tempdir="Examples/mountain/temp/"
